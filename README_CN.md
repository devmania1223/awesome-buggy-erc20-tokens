...
2018 年 5 月 20 日，严重的逻辑漏洞导致 EDU 用户的 Token 可被任意转出，同时还有其它 3 个 Token 也出现了相同问题 (CVE-2018–11397, CVE-2018–11398) [[5]](https://mp.weixin.qq.com/s/lf9vXcUxdB2fGY2YVTauRQ)。我们对以太坊上所有的智能合约的进一步深入分析表明，至少有 81 个合约具有相同性质的漏洞 [[6]](https://mp.weixin.qq.com/s/9FMt_TBSb9avL78KEAXHuA)。
